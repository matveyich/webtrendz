...
= 0.1.3 =
* Added the authprs names now show (online) after them on the blog if that person is online. Good for multi author blogs.
...
The plugin now uses gettext so can be easily translated into other languages.
