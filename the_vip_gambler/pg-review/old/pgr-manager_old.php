...
update_post_meta($pgr_pageid, '_wp_page_template', 'review_page.php');
  ...
  case 'doedit_mbox':
    ...
    <div class="wrap">
      <div id="icon-wp-pgr" class="icon32"><br /></div>
      <h2><?php _e('Edit Multiplay Box', 'pg-review'); ?></h2>
      <!-- Main Info -->
      <table class="form-table">
        <tr>
  ...
  //delete multiboxes
    ...
    <form name="mainform" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>?page=<?php echo plugin_basename(__FILE__); ?>">
      ...
      <div class="wrap">
          ...
          <tr>
            <td colspan="2">
			   ...
			   <div id="poststuff">
                <div id="<?php echo user_can_richedit() ? 'postdivrich' : 'postdiv'; ?>" class="postarea">
                  <div class="postbox">
                    <h3 class="hndle"><span><?php _e('Full Html') ?></span></h3>
                    <div class="inside">
        ...
        <h3><?php _e('MULTIPLAY BOXES', 'pg-review'); ?></h3>
        <table class="form-table">
        <?php
                ...
                <td colspan="2">
                    ...
                    <table class="form-table">
                      <tr>
                        ...
                        <td width="80%"><?php echo "$data_mtitle"; ?></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <th width="20%" scope="row" valign="top">&nbsp;</th>
                        <td width="80%">
                          <input type="button" value="<?php _e('Edit MultiBox', 'pg-review'); ?>" onclick="document.mainform.doaction.value='doedit_mbox'; document.mainform.mbox_id.value='<?php echo $data_mid; ?>'; document.mainform.submit();">
						  <input type="button" value="<?php _e('Delete MultiBox', 'pg-review'); ?>" onclick="document.mainform.doaction.value='dodel_mbox'; document.mainform.mbox_id.value='<?php echo $data_mid; ?>'; document.mainform.submit();">
                        </td>
                      </tr>
                      <tr>
                        <td colspan="2"><hr/></td>
