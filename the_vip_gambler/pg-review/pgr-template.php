...
*/
$pgr_rurl = get_bloginfo('url')."?reviewid=".$pgr_id;
$pgr_durl = get_bloginfo('url')."?reviewid=".$pgr_id."&download=1";

$pgr_fullhtml = str_replace("\'", "'", str_replace('&quot;', '"', stripslashes($pgr_fullhtml)));
$pgr_descr = str_replace("\'", "'", str_replace('&quot;', '"', stripslashes($pgr_descr)));
$contentofpage = "";

$contentofpage .= "<div id=\"main-wrap\">";
$contentofpage .= "  <div id=\"content\" class=\"review\">";
...
foreach(explode("\n",$pgr_descr) as $line) {
$line = trim($line);
if ($line != "") $contentofpage .= "<li>".$line."</li>";
}
//$contentofpage .= "                      </li>";
$contentofpage .= "                    </ul>";
$contentofpage .= "                  </div>";
...
$contentofpage .= "                          <h3 class=\"clearfix\"><span class=\"right-bg clearfix\"><span class=\"left-bg\">$pgr_offtitle</span></span></h3>";
$contentofpage .= "                        </div>";
$contentofpage .= "                        <div class=\"bd\">";
...
switch($pgr_bonustype)
{
	...
	break;
	case 2:
	$contentofpage .= "                          <div class=\"percent\">DEPOSIT $pgr_offvaluef </div>";
	$contentofpage .= "                          <div class=\"sep\"><br></div>";
	$contentofpage .= "                          <div class=\"amount\">PLAY WITH $pgr_offvaluet</div>";
	break;
	case 3:
	$contentofpage .= "                          <div class=\"percent\">$pgr_offvaluef </div>";
	$contentofpage .= "                          <div class=\"sep\"><br></div>";
	$contentofpage .= "                          <div class=\"amount\"> FREE</div>";
	break;
...
$contentofpage .= "                   <strong><a class=\"button\" href=\"$pgr_rurl\" target=\"_blank\">$pgr_offrvwlnktitle</a></strong>";
$contentofpage .= "                          </div>";
$contentofpage .= "                        </div>";
$contentofpage .= "                        </div>";
...
$contentofpage .= "      <div class=\"line moduletable\">";
$contentofpage .= "        <div class=\"unit size2of3\">";
$contentofpage .= "          <div id=\"review-full\" class=\"mod mod-article\">";
$contentofpage .= "            <div class=\"inner\">";

$contentofpage .= "              <h3 class=\"clearfix\"><span class=\"right-bg clearfix\"><span class=\"left-bg\">Full review</span></span></h3>
";
$contentofpage .= "              <div class=\"bd\">";
...
$contentofpage .= "                <br><br><a class=\"button\" href=\"$pgr_rurl\" target=\"_blank\">$visitlnk</a>";
$contentofpage .= "                </p>";
...
$contentofpage .= "              <div class=\"inner\">";
$contentofpage .= "                <h3 class=\"clearfix\"><span class=\"right-bg clearfix\"><span class=\"left-bg\">Info</span></span></h3>
";
$contentofpage .= "                <div class=\"bd\">";
...
$contentofpage .= "                    <dd class=\"paymentWrap\">";
...
//$data_mtitle - Title for multi boxes
      $contentofpage .= "          <h3 class=\"clearfix\"><span class=\"right-bg clearfix\"><span class=\"left-bg\">$data_mtitle</span></span></h3>";
      $contentofpage .= "          <div class=\"bd\">";
      $contentofpage .= "            <div class=\"block\">";
