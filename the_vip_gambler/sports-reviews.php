...
<? if (function_exists("list_several_reviews")) list_several_reviews("Sports");?>
...
<? if (function_exists("list_several_reviews")) list_several_reviews("Sports",0,"blocks_new");?>
