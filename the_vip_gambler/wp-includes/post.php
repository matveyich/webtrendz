...
function wp_insert_post($postarr = array(), $wp_error = false) {
	...
	// WTZ FIX START
	// this part checks whether the post is a review, and if it is, then we do not update the content part of the post
	if ($postarr['from_rvw_mngmnt'] != true and $wpdb->get_results("SELECT id FROM ".$wpdb->prefix."pgrvw WHERE padeid = $post_ID")) 
	{
	$data = compact( array( 'post_author', 'post_date', 'post_date_gmt', 'post_title', 'post_excerpt', 'post_status', 'post_type', 'comment_status', 'ping_status', 'post_password', 'post_name', 'to_ping', 'pinged', 'post_modified', 'post_modified_gmt', 'post_parent', 'menu_order', 'guid' ) );
	} else {
