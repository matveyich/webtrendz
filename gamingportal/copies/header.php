...
<head>
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/ja_tabs.css" type="text/css">
...
<!--<script type="text/javascript" src="<? bloginfo('template_url');?>/jquery-1.3.2.min.js"></script>
<script type="text/javascript" src="<? bloginfo('template_url');?>/jquery.scrollable.min.js"></script>-->  
