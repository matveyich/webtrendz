  ...
  */
  ...
  <form name="form2" method="post" action="<?php the_permalink();//wpmem_chk_qstr();?>">
	...
	<tr>
      ...
      <td>
		<input type="checkbox" name="gp_casino" value="1" <? if(1==$gp_casino) echo "checked";?>> Casino<br>
		<input type="checkbox" name="gp_poker" value="1" <? if(1==$gp_poker) echo "checked";?>> Poker<br>
		<input type="checkbox" name="gp_sports" value="1" <? if(1==$gp_sports) echo "checked";?>> Sports<br>
	  </td>
    </tr>
	<tr>
      <td align="right">Favourite casino games</td>
      <td>
		<input type="checkbox" name="fcg_slots" value="1" <? if(1==$fcg_slots) echo "checked";?>> Slots<br>
		<input type="checkbox" name="fcg_blackjack" value="1" <? if(1==$fcg_blackjack) echo "checked";?>> Blackjack<br>
		<input type="checkbox" name="fcg_roulette" value="1" <? if(1==$fcg_roulette) echo "checked";?>> Roulette<br>
		<input type="checkbox" name="fcg_sicbo" value="1" <? if(1==$fcg_sicbo) echo "checked";?>> Sic Bo<br>
		<input type="checkbox" name="fcg_baccarat" value="1" <? if(1==$fcg_baccarat) echo "checked";?>> Baccarat<br>
		<input type="checkbox" name="fcg_videopoker" value="1" <? if(1==$fcg_videopoker) echo "checked";?>> Video Poker<br>
		<input type="checkbox" name="fcg_craps" value="1" <? if(1==$fcg_craps) echo "checked";?>> Craps<br>
		<input type="checkbox" name="fcg_keno" value="1" <? if(1==$fcg_keno) echo "checked";?>> Keno<br>
		<input type="checkbox" name="fcg_paigowpoker" value="1" <? if(1==$fcg_paigowpoker) echo "checked";?>> Pai Gow Poker<br>
	  </td>
    </tr>
	<tr>
      <td align="right">Favourite poker</td>
      <td>
		<input type="checkbox" name="fp_texas" <? if(1==$fp_texas) echo "checked";?> value="1"> Texas Hold&#8242;em<br>
		<input type="checkbox" name="fp_omaha" <? if(1==$fp_omaha) echo "checked";?> value="1"> Omaha<br>
		<input type="checkbox" name="fp_omahahilo" <? if(1==$fp_omahahilo) echo "checked";?> value="1"> Omaha Hi-Lo<br>
		<input type="checkbox" name="fp_7card" <? if(1==$fp_7card) echo "checked";?> value="1"> 7 Card Stud<br>
		<input type="checkbox" name="fp_headsup" <? if(1==$fp_headsup) echo "checked";?> value="1"> Heads up Poker<br>
		<input type="checkbox" name="fp_smg" <? if(1==$fp_smg) echo "checked";?> value="1"> SNG&#8242;s<br>
		<input type="checkbox" name="fp_tournaments" <? if(1==$fp_tournaments) echo "checked";?> value="1"> Tournaments<br>
	  </td>
    </tr>
	<tr>
      <td align="right">Do you play Live Dealer casino</td>
      <td>
		<input type="radio" name="ldc" <? if(1==$ldc) echo "checked";?> value="1"> Yes<br>
		<input type="radio" name="ldc" <? if(0==$ldc) echo "checked";?> value="0"> No<br>
	  </td>
    </tr>
	<tr>
      <td align="right">Frequency of play</td>
      <td>
		<input type="radio" name="fop" <? if(1==$fop) echo "checked";?> value="1"> Daily<br>
		<input type="radio" name="fop" <? if(2==$fop) echo "checked";?> value="2"> Weekly<br>
		<input type="radio" name="fop" <? if(3==$fop) echo "checked";?> value="3"> Fortnightly<br>
		<input type="radio" name="fop" <? if(4==$fop) echo "checked";?> value="4"> Monthly<br>
		<input type="radio" name="fop" <? if(5==$fop) echo "checked";?> value="5"> Other<br>
	  </td>
    </tr>
	<tr>
      <td align="right">Current monthly wager</td>
      <td>
		<input type="radio" name="cmw" <? if(1==$cmw) echo "checked";?> value="1"> &#163;1000<br>
		<input type="radio" name="cmw" <? if(2==$cmw) echo "checked";?> value="2"> &#163;1000-5000<br>
		<input type="radio" name="cmw" <? if(3==$cmw) echo "checked";?> value="3"> &#163;5000-10000<br>
		<input type="radio" name="cmw" <? if(4==$cmw) echo "checked";?> value="4"> &#163;10000+<br>
	  </td>
    </tr>
	<tr>
      <td align="right">Current monthly Cash Back Programme</td>
      <td>
		<input type="radio" name="cmcbp"  <? if(1==$cmcbp) echo "checked";?> value="1"> 5%<br>
		<input type="radio" name="cmcbp"  <? if(2==$cmcbp) echo "checked";?> value="2"> 10%<br>
		<input type="radio" name="cmcbp"  <? if(3==$cmcbp) echo "checked";?> value="3"> 15%<br>
	  </td>
    </tr>
	<tr>
      <td align="right">Favourite VIP Reward</td>
      <td>
		<input type="radio" name="fvp" <? if(1==$fvp) echo "checked";?> value="1"> Cash Bonus<br>
		<input type="radio" name="fvp" <? if(2==$fvp) echo "checked";?>  value="2"> Hospitality Event<br>
		<input type="radio" name="fvp" <? if(3==$fvp) echo "checked";?> value="3"> Luxury Gift<br>
	  </td>
    </tr>
