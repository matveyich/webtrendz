...
*/
        ...
        $html .= "    <td>\n";
		$html .= "    <input type='hidden' name='alo_em_opt_email' value='Guest' id='opt_email' size='10' maxlength='50' />\n";
		$html .= "    <input type='text' name='alo_em_opt_email' value='". $alo_em_opt_email ."' id='opt_email' size='10' maxlength='50' />\n";
    	$html .= "    </td>\n";
        $html .= "  </tr>\n";
        $html .= "</tbody></table>\n";
 		$html .= $lists_table; // add lists table
