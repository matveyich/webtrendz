...
// exclude some of properties module pages
		global $pr_slug,$pr_newsletter_slug,$pr_user_properties_slug,$pr_user_downloads_slug,$pr_tennant_slug;
		if (function_exists('pr_init_')){
		$sqlpages .= "AND post_name NOT IN ('$pr_slug','$pr_newsletter_slug','$pr_user_properties_slug','$pr_user_downloads_slug','$pr_tennant_slug','my-account') ";
		}
