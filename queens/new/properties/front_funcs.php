...
?>
<div class="stageBreadcrumb"><ul><li>Step 1</li><li>Step 2</li><li class="current">Step 3</li><li>Step 4</li></ul></div><div class="addPropStage stage3">
<?
...
$pagestring = "Pages ";
/**/
    $_common_params = array();
    if (isset($_GET['pr_action'])){
        $_common_params['pr_action'] = $_GET['pr_action'];
    }
	for ($i = 1;$i <= $pages;$i++)
	{

		$_common_params['pr_page_id'] = $i;
        if ($pr_page_id == $i)
		{
		    $_class = 'selected';
		} else {
        	...
        	$pagestring .= "<a class='".$_class."' href=".get_permalink(get_page_by_path($pr_user_properties_slug))."?".http_build_query($_common_params).">".$i."</a> ";
	}
...
function prf_area_select_form($area_id){
	if ((isset($_POST['band_area']) and $_POST['band_area']==0)) {
		// international areas
		$_GET['exclude'] = 222;
	}

    echo pr_get_area_parents($area_id);
	$_include_parent = 222;
	$_include_areas = array();
	pr_find_children($_include_parent, &$_include_areas);
	//print_r($_include_areas);
