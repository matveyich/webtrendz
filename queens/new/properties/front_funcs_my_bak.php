...
function pr_property_show($id)//property details
{
  ...
  switch($type)
	...
	<?prf_images($id)?>
		...
		<div id="information">
		<h3><a href="#description"><img src="<?bloginfo('template_url');?>/images/propDes.png" /></a></h3>
		<div id="description">
			<?echo $prop->descr;?>
		</div>
		<h3><a href="#videos"><img src="<?bloginfo('template_url');?>/images/videos.png" /></a></h3>
		<div id="videos">
...
<?*/?>
		<h3><a href="#files"><img src="<?bloginfo('template_url');?>/images/files.png" /></a></h3>
		<div id="files">
...
?>
<h3><a href="#aform"><img src="<?bloginfo('template_url');?>/images/features.png" alt="Arrange viewing for this property"/></a></h3>
...
<form action="" method="post">
	<div id="form">
		...
		<input name="contactNumber" id="contactNumber" value="" type="text">
		...
		<input value="Arrange viewing" type="submit">
		<?
...
<?  
  foreach($orders as $order)
  {
    ...
    $user_info = get_userdata($order->user_id);
      ...
      <td>
      <a href="javascript:open_win(<?echo plugins_url('/order_details.php?order_id='.$order->ID, __FILE__)?>)">View</a>
	  <?
      /*
