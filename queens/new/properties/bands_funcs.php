...
$(".band_list tbody").tabs(".band_list div.hidden_description", {tabs:"tr a.list_number",effect:"slide",initialIndex:null});
});
</script>
<div class="band_list">
<table class="widefat">
...
<tr>
		<td>
		<span class='list_number' name="<?echo $band->bandid?>"><?echo $band->bandid?></span>
		</td>
		<td>
		<div class="band_name">
                <?echo $band->bandname?>
                <a href="#" class="BandMore" name="<?echo $band->bandid?>">More</a>
        </div>
...
if (is_admin()) {
    ...
    $uq = 'update '.$pr_properties.' set basketid=0 where basketid in ('.$_delete.') and user_id='.$user_id;
    $wpdb->query($uq);
...
*/?>
    ...
    <div class="stageBreadcrumb"><ul><li class="current">Step 1</li><li>Step 2</li><li>Step 3</li><li>Step 4</li></ul></div><div class="addPropStage stage1"><label><span>Property Type:</span>
<? pr_property_types_select($_POST['property_types'],'disabled'); ?>
</span></div>
<div class="stageBreadcrumb"><ul><li>Step 1</li><li class="current">Step 2</li><li>Step 3</li><li>Step 4</li></ul></div><div class="addPropStage stage1"><label><span>Property Location:</span>
...
switch($_POST['property_types'])
{
	...
	if (!isset($_POST['property_types'])) {	
		echo '<div class="stageBreadcrumb"><ul><li class="current">Step 1</li><li>Step 2</li><li>Step 3</li><li>Step 4</li></ul></div><div class="addPropStage stage1"><label><span>Property Type:</span>';
		...
		pr_property_types_select($_POST['property_types'],'disabled');
		echo '</label></div>';
		echo  '<div class="stageBreadcrumb"><ul><li>Step 1</li><li class="current">Step 2</li><li>Step 3</li><li>Step 4</li></ul></div><div class="addPropStage stage2"><label><span>Property Location:</span>';	
...
<script>
$(document).ready(function() {
$(".prop_band_list tbody").tabs(".prop_band_list div.hidden_description", {effect:"slide", tabs:".prop_band_name", initialIndex:null});
