//// some variables for prperties forms
var thumbnail;
...
function uploadSuccess(fileObj, server_data) {
	try {
		...
		if (thumbnail_create == true)
		{
			AddImage(thumbnail + "?id=" + server_data);
		}
...
function FileProgress(fileObj, target_id) {
	...
	this.file_progress_id =  "divFileProgress" + "_" + target_id;
...
function AddImage(src) {
	...
	document.getElementById(thumbnails_id).appendChild(new_img);
	if (new_img.filters) {
		try {
