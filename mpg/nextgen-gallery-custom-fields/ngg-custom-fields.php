...
//{
	...
	//api stuff{
		...
		define("NGGCF_FIELD_TYPE_CHECKBOX", 4);
				...
				foreach ((array)$fields as $key=>$val) {
					...
					<tr>
						...
						<td>
							...
							case NGGCF_FIELD_TYPE_CHECKBOX : echo "Checkbox"; break;
							}
							?>
						</td>
						<td>
					...
					<table class="form-table">
						...
						<tr valign="top"> 
							...
							<td>
								...
								<option value="<?php echo NGGCF_FIELD_TYPE_CHECKBOX; ?>">Checkbox</option>
								</select>
							</td>
						</tr>
	...
	function nggcf_admin_col($gallery_column_key, $pid) {
		...
		case NGGCF_FIELD_TYPE_SELECT :
			...
			<?php	break;
			case NGGCF_FIELD_TYPE_CHECKBOX :?>
			<input name="nggcf_fields[<?php echo $pid ?>][<?php echo $custCol->id ?>]" value="1"  />
			<?php	break;
			}
						...
						jQuery("#gallerydiv table.form-table").each(function(item) { //the table with gallery fields
								...
								foreach ((array)$fields as $key=>$val) {
									...
									case NGGCF_FIELD_TYPE_SELECT :
										...
										<?php	break;
									case NGGCF_FIELD_TYPE_CHECKBOX :?>
										cell.innerHTML = '<input name="nggcf_gallery[<?php echo $val->id; ?>]" value="1" />';
										<?php	break;										
									}
								}
								?>
