...
if ( function_exists('register_sidebar') ) {
	register_sidebar(array(
		...
		'id' => 'homepage-blocks',
		'before_widget' => '<div class="com30 gryGrad eqlHght">',
		'after_widget' => '</div>',
		'before_title' => '<h2>',
		'after_title' => '</h2>',
	));
	...
	'name' => 'Footer blocks',
	'id' => 'footer-blocks',
	'before_widget' => '<div class="social_bookmarks">',
	'after_widget' => '</div>',
	'before_title' => '<h2 class="s_title">',
	'after_title' => '</h2>',
));
	register_sidebar(array(
	'name' => 'Latest news blocks',
	'id' => 'latest-news-blocks',
	'before_widget' => '<div class="com30 gryGrad eqlHght">',
	'after_widget' => '</div>',
	'before_title' => '<h2>',
	'after_title' => '</h2>',
...
// this functions
function show_posts($args,$div_class='secondaryContent'){
 // LAST POSTS EXCEPT FEATURED
	$posts = get_posts($args);
?>
<?php if (sizeof($posts)>0) : ?>
		<div class="<?echo $div_class?>">
...
<?php //while (have_posts()) : the_post(); ?>
 ...
 ?>
			...
			<div class="com30 gryGrad eqlHght" id="post--<?php echo $post->ID; ?>">
				<div>
				<h2><a href="<?php echo get_permalink($post->ID) ?>" title="Permanent Link to <?php echo $post->post_title; ?>"><?php echo $post->post_title; ?></a></h2>

				<div class="entry">
<?
$img_src=p75GetThumbnail($post->ID);
if (strlen($img_src)>0) {
	?>
...
?>
				...
				<div class="lnk">
					<a href="<?php echo get_permalink($post->ID) ?>" title="Permanent Link to <?php echo $post->post_title; ?>">Read more</a>
				</div>
			</div>
...
register_sidebar_widget('Social Bookmarks Widget', 'widget_social');
